...
const FoodCard = (props: FoodProps & { size?: CSSProperties }) => {
  const { food_description, food_id, food_image, food_name, food_price , size } =
    props;
  return (
    <div className={cx("food_card_container")} style={size}>
