...
const FoodCard = forwardRef<
  HTMLDivElement,
  FoodProps & { style?: CSSProperties }
>(
  (
    { food_description, food_id, food_image, food_name, food_price, style },
    ref
  ) => {
    return (
      <div className={cx("food_card_container")} style={{ ...style }} ref={ref}>
